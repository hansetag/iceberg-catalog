pub mod v1 {
    ...
    use crate::modules::{object_stores::S3Flavor, CatalogBackend, SecretStore, State};
    ...
    pub struct ApiServer<C: CatalogBackend, A: AuthZHandler, S: SecretStore> {
    ...
    async fn create_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
    ...
    async fn list_projects<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ...
    async fn list_warehouses<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
    ...
    async fn get_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
    ...
    async fn delete_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ) -> Result<()> {
    ...
    async fn rename_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ...
    async fn deactivate_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ) -> Result<()> {
    ...
    async fn activate_warehouse<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ) -> Result<()> {
    ...
    async fn update_storage_profile<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ...
    async fn update_storage_credential<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
        AxumState(api_context): AxumState<ApiContext<State<A, C, S>>>,
        Extension(metadata): Extension<RequestMetadata>,
    ...
    async fn list_deleted_tabulars<C: CatalogBackend, A: AuthZHandler, S: SecretStore>(
        Path(warehouse_id): Path<uuid::Uuid>,
    ...
    impl<C: CatalogBackend, A: AuthZHandler, S: SecretStore> ApiServer<C, A, S> {
