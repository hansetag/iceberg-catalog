...
use crate::service_modules::object_stores::error::{
    CredentialsError, FileIoError, TableConfigError, UpdateError, ValidationError,
};
use crate::service_modules::object_stores::path_utils::reduce_scheme_string;
use crate::service_modules::object_stores::{StoragePermissions, StorageProfile, StorageType};
...
mod test {
    ...
    mod azure_tests {
        use crate::service_modules::object_stores::{AzCredential, AzdlsProfile};
        use crate::service_modules::object_stores::{StorageCredential, StorageProfile};
