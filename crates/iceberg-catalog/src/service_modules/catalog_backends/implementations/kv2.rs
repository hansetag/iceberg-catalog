...
use crate::service_modules::health::{Health, HealthExt, HealthStatus};
use crate::service_modules::secrets::{Secret, SecretIdent, SecretStore};
...
mod tests {
    ...
    mod kv2 {
        use crate::service_modules::object_stores::{S3Credential, StorageCredential};
        use crate::CONFIG;
