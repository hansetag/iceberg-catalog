...
use crate::service_modules::catalog_backends::implementations::postgres::tabular::view::{
...
use crate::service_modules::tabular_idents::{TabularIdentOwned, TabularIdentUuid};
...
impl CatalogBackend for super::PostgresCatalog {
    ...
    async fn load_view<'a>(
        ...
        include_deleted: bool,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ) -> Result<crate::service_modules::catalog_backends::implementations::postgres::tabular::view::ViewMetadataWithLocation>{
