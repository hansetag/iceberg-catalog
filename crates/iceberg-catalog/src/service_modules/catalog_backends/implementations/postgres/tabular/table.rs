...
use crate::service_modules::{TableCommit, TableCreation};
use crate::{
    service_modules::{
...
use crate::service_modules::catalog_backends::implementations::postgres::tabular::{
...
pub(crate) async fn table_ident_to_id<'e, 'c: 'e, E>(
    ...
    table: &TableIdent,
    list_flags: crate::service_modules::ListFlags,
    catalog_state: E,
) -> Result<Option<TableIdentUuid>>
where
    E: 'e + sqlx::Executor<'c, Database = sqlx::Postgres>,
{
    crate::service_modules::catalog_backends::implementations::postgres::tabular::tabular_ident_to_id(
        warehouse_id,
...
where
    E: 'e + sqlx::Executor<'c, Database = sqlx::Postgres>,
{
    let table_map = crate::service_modules::catalog_backends::implementations::postgres::tabular::tabular_idents_to_ids(
        warehouse_id,
        tables
            .into_iter()
...
pub(crate) async fn rename_table(
    ...
    crate::service_modules::catalog_backends::implementations::postgres::tabular::rename_tabular(
        warehouse_id,
...
pub(crate) mod tests {
    ...
    use crate::service_modules::catalog_backends::implementations::postgres::warehouse::set_warehouse_status;
    use crate::service_modules::catalog_backends::implementations::postgres::warehouse::test::initialize_warehouse;
    use crate::service_modules::{ListFlags, NamespaceIdentUuid};

    use crate::catalog::test::{initialize_table, setup};
    use crate::service_modules::catalog_backends::implementations::postgres::tabular::mark_tabular_as_deleted;
