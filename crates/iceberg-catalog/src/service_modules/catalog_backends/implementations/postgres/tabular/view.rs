...
use crate::service_modules::catalog_backends::implementations::postgres::dbutils::DBErrorHandler as _;
use crate::{
    service_modules::{ErrorModel, NamespaceIdentUuid, Result, TableIdent, TableIdentUuid},
    WarehouseIdent,
};
...
use crate::service_modules::catalog_backends::implementations::postgres::{tabular, CatalogState};
use crate::service_modules::ListFlags;
pub(crate) use crate::service_modules::ViewMetadataWithLocation;
...
pub(crate) mod tests {
    ...
    use crate::service_modules::catalog_backends::implementations::postgres::tabular::view::load_view;
    use crate::service_modules::catalog_backends::implementations::postgres::warehouse::test::initialize_warehouse;
    use crate::service_modules::catalog_backends::implementations::postgres::CatalogState;

    use crate::service_modules::TableIdentUuid;
  ...
  "properties": {
    ...
    async fn create_view(pool: sqlx::PgPool) {
        ...
        let namespace_id =
            crate::service_modules::catalog_backends::implementations::postgres::tabular::table::tests::get_namespace_id(
                state.clone(),
                warehouse_id,
                &namespace,
            )
