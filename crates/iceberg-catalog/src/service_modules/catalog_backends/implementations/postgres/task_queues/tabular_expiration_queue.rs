...
use crate::service_modules::catalog_backends::implementations::postgres::dbutils::DBErrorHandler;
use crate::service_modules::catalog_backends::implementations::postgres::tabular::TabularType as DbTabularType;
use crate::service_modules::catalog_backends::implementations::postgres::task_queues::{
    pick_task, queue_task, record_failure, record_success,
};
use crate::service_modules::catalog_backends::implementations::postgres::DeletionKind;
use crate::service_modules::task_queue::tabular_expiration_queue::{
...
mod test {
    ...
    async fn test_queue_expiration_queue_task(pool: PgPool) {
        ...
        assert_eq!(
            task.deletion_kind,
            crate::service_modules::catalog_backends::implementations::postgres::DeletionKind::Default
                .into()
        );
