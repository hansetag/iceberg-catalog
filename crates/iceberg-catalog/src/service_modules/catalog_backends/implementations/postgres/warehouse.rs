...
use crate::service_modules::config::ConfigProvider;
use crate::service_modules::{GetWarehouseResponse, WarehouseStatus};
use crate::{
    service_modules::object_stores::StorageProfile, ProjectIdent, SecretIdent, WarehouseIdent,
};
use http::StatusCode;
use sqlx::Error;
...
pub(crate) mod test {
    ...
    use crate::{
        service_modules::catalog_backends::implementations::postgres::PostgresTransaction,
        service_modules::{object_stores::S3Profile, CatalogBackend as _, Transaction as _},
    };
