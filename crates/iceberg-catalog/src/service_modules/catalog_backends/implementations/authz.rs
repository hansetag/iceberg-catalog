...
use crate::service_modules::health::HealthExt;
use crate::{
    service_modules::catalog_backends::implementations::DEFAULT_PROJECT_ID,
    service_modules::{
...
impl HealthExt for AllowAllAuthState {
    async fn health(&self) -> Vec<crate::service_modules::health::Health> {
        vec![]
    }
