...
use crate::service::object_stores::path_utils::reduce_scheme_string;
use crate::service::object_stores::{StoragePermissions, StorageProfile, StorageType};
...
mod test {
    ...
    mod azure_tests {
        use crate::service::object_stores::{AzCredential, AzdlsProfile};
