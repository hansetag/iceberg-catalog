...
use crate::service::compression_codec::CompressionCodec;
use crate::service::io::write_metadata_file;
use crate::service::tabulars::tables::{
    determine_tabular_location, maybe_body_to_json, require_active_warehouse,
    validate_table_or_view_ident,
};
use crate::service::tabulars::views::validate_view_properties;
use crate::service::{maybe_get_secret, require_warehouse_id};
use http::StatusCode;
