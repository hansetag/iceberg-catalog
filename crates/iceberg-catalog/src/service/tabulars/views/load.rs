...
use crate::modules::{CatalogBackend, SecretStore, State, Transaction, ViewMetadataWithLocation};
...
use crate::service::tabulars::tables::{require_active_warehouse, validate_table_or_view_ident};
use http::StatusCode;
...
#[cfg(test)]
pub(crate) mod test {
    use crate::rest::iceberg::v1::{Prefix, ViewParameters};
