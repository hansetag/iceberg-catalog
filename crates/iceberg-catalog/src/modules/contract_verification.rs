...
///     use iceberg::spec::{TableMetadata, ViewMetadata};
///     use iceberg::{TableIdent, TableUpdate};
///     use iceberg_catalog::modules::{tabular_idents::TabularIdentUuid, contract_verification::{ContractVerification, ContractVerificationOutcome}};
///     use iceberg_ext::catalog::rest::{ErrorModel, ViewUpdate};
///
///     #[derive(Debug)]
...
impl ContractVerificationOutcome {
    ...
    ///
    /// ```rust
    ///     use iceberg_catalog::modules::contract_verification::ContractVerificationOutcome;
