...
use crate::service::io::list_location;
...
impl StorageProfile {
    ...
    pub async fn validate_access(
        ...
        // Cleanup
        crate::service::io::remove_all(&file_io, &test_location)
            .await
    ...
    async fn validate_read_write(
        ...
        // Test write
        crate::service::io::write_metadata_file(
            &test_file_write,
            "test",
            compression_codec,
            file_io,
        ...
        // Test read
        let _ = crate::service::io::read_file(file_io, &test_file_write)
            .await
            .map_err(|e| ValidationError::IoOperationFailed(e, Box::new(self.clone())))?;

        // Test delete
        crate::service::io::delete_file(file_io, &test_file_write)
            .await
            .map_err(|e| ValidationError::IoOperationFailed(e, Box::new(self.clone())))?;
