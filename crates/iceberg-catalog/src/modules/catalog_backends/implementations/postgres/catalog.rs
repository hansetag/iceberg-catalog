...
use crate::modules::catalog_backends::implementations::postgres::tabular::view::{
...
impl CatalogBackend for super::PostgresCatalog {
    ...
    async fn load_view<'a>(
        ...
        include_deleted: bool,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ) -> Result<crate::modules::catalog_backends::implementations::postgres::tabular::view::ViewMetadataWithLocation>{
