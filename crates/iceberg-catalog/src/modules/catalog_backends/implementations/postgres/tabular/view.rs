...
use crate::modules::catalog_backends::implementations::postgres::dbutils::DBErrorHandler as _;
use crate::{
    modules::{ErrorModel, NamespaceIdentUuid, Result, TableIdent, TableIdentUuid},
    WarehouseIdent,
};
...
use crate::modules::catalog_backends::implementations::postgres::{tabular, CatalogState};
use crate::modules::ListFlags;
...
pub(crate) mod tests {
    ...
    use crate::modules::catalog_backends::implementations::postgres::tabular::view::load_view;
    use crate::modules::catalog_backends::implementations::postgres::warehouse::test::initialize_warehouse;
    use crate::modules::catalog_backends::implementations::postgres::CatalogState;

    use crate::modules::TableIdentUuid;
  ...
  "properties": {
    ...
    async fn create_view(pool: sqlx::PgPool) {
        ...
        let namespace_id =
            crate::modules::catalog_backends::implementations::postgres::tabular::table::tests::get_namespace_id(
                state.clone(),
                warehouse_id,
                &namespace,
            )
