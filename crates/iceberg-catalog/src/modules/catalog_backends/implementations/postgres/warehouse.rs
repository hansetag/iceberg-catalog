...
use crate::modules::config::ConfigProvider;
use crate::modules::{GetWarehouseResponse, WarehouseStatus};
...
pub(crate) mod test {
    ...
    use crate::{
        modules::catalog_backends::implementations::postgres::PostgresTransaction,
        modules::{object_stores::S3Profile, CatalogBackend as _, Transaction as _},
    };
