...
use crate::rest::{iceberg::v1::NamespaceIdent, Result};
use crate::{
    modules::catalog_backends::implementations::DEFAULT_PROJECT_ID,
    modules::{
...
impl HealthExt for AllowAllAuthState {
    async fn health(&self) -> Vec<crate::modules::health::Health> {
        vec![]
    }
