...
| `ICEBERG_DEFAULT_TABULAR_EXPIRATION_DELAY_SECONDS` | `86400`                          | Default time after which a tabular, i.e. View or Table which has been dropped is going to be deleted. Can be overwritten on warehouse level. Default: `86400`                                                                  |
